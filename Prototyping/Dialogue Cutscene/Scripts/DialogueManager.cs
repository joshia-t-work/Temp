...
public class DialogueManager : MonoBehaviour
{
    ...
    [HideInInspector] public string check = "";
    [HideInInspector] public string size = "";
    [HideInInspector] public bool bold = false;
    [HideInInspector] public bool italic = false;
    [HideInInspector] public bool customSize = false;
    private string Line;
